...
export const whatsappLinks = {
    ...
    cotizarEps: `https://wa.me/${seguridadSocialPhone}?text=${encodeURIComponent(
        "Hola, vi el sitio web y quiero afiliarme a solo EPS"
    )}`,
    cotizarArl: `https://wa.me/${seguridadSocialPhone}?text=${encodeURIComponent(
    ...
    cotizarPension: `https://wa.me/${seguridadSocialPhone}?text=${encodeURIComponent(
